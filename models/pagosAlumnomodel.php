...
class pagosAlumnoModel extends Model
{
    ...
    public function getAllPagos($id_alumno)
    {
        ...
        try {
            $query = $this->db->connect()->prepare("SELECT Nombre_Alumno,Detalle_mes,Pago,Concepto,Fecha_registro FROM vw_detalle_pagos WHERE No_alumno=:no_al AND estatus_id_pago=108");
