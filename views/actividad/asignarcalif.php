...
<body>
  ...
  <div class="card">
    <div class="card-body">
      ...
      <form class="row p-3" action="<?php echo constant('URL'); ?>actividad/CalificacionAct" method="POST" autocomplete="off">
        <input type="hidden" class="form-control" name="txt_Idcalif" value="<?php echo $this->varTodas->vw_ca_calificacion; ?>" readonly>
        <div class="row">
          <div class="col-md-6">
